...
<div class="row">
   ...
   <div class="col-lg-4 mt-2">
      ...
      <form action="" method="GET">
         <div class="card my-4">
            <h5 class="card-header">Cari Informasi Musik</h5>
            <div class="card-body">
               <div class="input-group">
                  <input type="text" class="form-control" name="key" placeholder="Ketik disini...">
                  <!-- <input type="hidden" name="halaman" value="1"> -->
                  <span class="input-group-btn">
                  <button class="btn btn-success" name="open" type="submit" value="cari">Cari!</button>
                  </span>
               </div>
            </div>
         </div>
