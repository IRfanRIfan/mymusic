...
<table border="0">
	<tr>
		...
		<button type="submit" class="btn btn-success btn-sm" name="uploadlogo">Upload Logo</button>
		...
		<button type="submit" class="btn btn-success btn-sm mt-1" name="uploadicon">Upload Icon</button>
...
<table class="table table-borderless">
    ...
    <tr>
    <td class="text-left">
    	<button type="submit" class="btn btn-success btn-sm" name="tambahkonfigurasi">Tambah</button>
    </td>
    </tr>
</table>
...
<table class="table table-borderless">
    ...
    <?php endwhile; ?>
    	<td class="text-left">
    		<button type="submit" class="btn btn-success btn-sm" name="editkonfigurasi">Edit</button>
    	</td>
    	<td></td>
    	<td></td>
    	<td></td>
