...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-success position-static fixed-top" style="margin-top: -55px; height: 80px;">
  <img class="navbar-brand" src="image/newslogo.png" style="width: 120px; height: 90px;">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <!-- <a class="nav-link" href="./">Info Musik</a> -->
          </li>
